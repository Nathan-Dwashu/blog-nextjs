      ...
      <div className="container mx-auto p-4 relative">
        <div className="bg-white border-2 border-purple-100 rounded-lg p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col justify-center">
            <h1 className={`text-4xlfont-bold mb-4 ${styles.text_wisteria}`}>Welcome Stranger</h1>
            <h2 className={`text-4xlfont-bold mb-4 ${styles.text_wisteria}`}>This is you Blog</h2>
